...
if ( ! function_exists( 'challenge_setup' ) ) :
	...
	function challenge_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'challenge' ),
		) );
...
function challenge_scripts() {
	...
	wp_enqueue_script( 'challenge-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'challenge-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
